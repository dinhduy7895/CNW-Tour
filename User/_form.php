<form action="_check.php<?php echo isset($id) ? '?id=' . $id : ''; ?>" method="post">
 <?php
    ...
    <div class="form-group field-user-username required">
        ...
        <input type="text" id="user-name" class="form-control" name="name" maxlength="255" required="required" value='<?php echo isset($row) ? $row['name'] : ''; ?>'>

        <div class="help-block"></div>
    </div>
    <div class="form-group field-user-username required">
        <label class="control-label" for="user-password">Password</label>
        <input type="password" id="user-password" class="form-control" name="pass" maxlength="255" required="required" value='<?php echo isset($row) ? $row['password'] : ''; ?>'>

        <div class="help-block"></div>
    </div>
    <div class="form-group field-user-username required">
        <label class="control-label" for="user-re-password">Confirm Password</label>
        <input type="password" id="user-re-password" class="form-control" name="rePass" maxlength="255" required="required" value='<?php echo isset($row) ? $row['password'] : ''; ?>'>
