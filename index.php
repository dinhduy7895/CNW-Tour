...
<section class="news">
    <div class="container">
        ...
        <div class="col-lg-4 col-md-4 slide-right">
            <div class="col-lg-12 col-md-12 new-right">
                                ...
                                <div class="menu-tag">
                                    <ul>
                                        ...
                                        foreach ($addressList as $address) {
                                            ?>
                                        <li><a href="tour.php?addressId=<?php echo $address->id;?>" class="menu-tag-item"><?php echo $address->name;?></a></li>
                                        <?php } ?>
                                ...
                                <div class="menu-tag">
                                    <ul>
                                        ...
                                        foreach ($typeList as $type) {
                                            ?>
                                        <li><a href="tour.php?typeId=<?php echo $type->id;?>" class="menu-tag-item"><?php echo $type->name;?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            ...
                            <div class="view-header">
                                ...
                                <div class="menu-tag">
                                    <ul>
                                        ...
                                        foreach ($tours as $tour) {
                                            ?>
                                        <li><a href="tour.php?dayTour=<?php echo $tour->dayTour;?>" class="menu-tag-item"><?php echo $tour->dayTour;?> days</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
